  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="/user/pengajuan">
              ...
              <div class="card shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="h3 font-weight-bold text-primary text-uppercase mb-1 text-center">Form Pengajuan Aplikasi</div>
                      <br>
                      {{-- FORM --}}
                      <form class="user" action="/user/pengajuan/proses" method="POST">

                        {{ csrf_field() }}

                        <input type="hidden" name="status" value="1">
                        <input type="hidden" name="progres_id" value="1">
                        <input type="hidden" name="pengembanganUmum" value="1">
                        <input type="hidden" name="pengembang_id" value="0">
                        ...
                        <div class="form-group row">
                          <div class="col-sm-12 mb-3 mb-sm-0">
                            <button type="submit" class="btn btn-primary btn-user">Ajukan</button>
                          </div>
                        </div>
                      </form>
                    </div>
